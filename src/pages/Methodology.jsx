...
export default function Methodology() {
  ...
  return <><div className="page-head"><div><h1 className="page-title">How the <span className="accent">score works</span></h1><p className="page-sub">Transparent weights, consistent inputs, and an explicit penalty for missing evidence.</p></div></div>
    <div className="grid grid-2"><section className="card card-pad"><div className="sec-label">Overall research score</div><div className="weight-stack"><div style={{ width: '75%' }}>75% fundamentals</div><div style={{ width: '15%' }}>15% behavior</div><div style={{ width: '10%' }}>10% news</div></div><p className="body-copy">Fundamentals dominate. Technical behavior measures trend, relative strength versus SPY, volatility, and drawdown. News sentiment is deliberately the smallest input.</p></section>
      <section className="card card-pad"><div className="sec-label">Guardrails</div><ul className="method-list"><li>PEG pairs provider-consistent inputs; it is not reconstructed from mismatched periods.</li><li>Industry context beats universal P/E or P/S thresholds.</li><li>Missing metrics reduce confidence and the final score.</li><li>The top 20 are selected from {data?.universe_count || 'the configured'} candidates; scores do not forecast returns.</li></ul></section></div>
