...
const GROUPS = [
  ...
  },
  {
    ...
    terms: [
      ...
      ['Realized volatility percentile', 'Where a stock’s current 20-day realized volatility sits (0-100) versus its own trailing one-year range of that same rolling figure – the "volatility cone" technique, applied to realized (not implied) volatility. This is deliberately not an IV rank: a true IV rank needs a year of implied-volatility history that this app does not currently collect, so this is the closest honest substitute available from price history alone. Blank when there isn’t enough trading history to compute it.'],
